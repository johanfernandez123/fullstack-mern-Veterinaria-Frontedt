      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          >
              ...
              <div className="my-3">
                  <label htmlFor="tel" className="uppercase  font-bold text-gray-600">Teléfono</label>
                  <input 
                    id="tel"
                    type="tel" 
                    className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"
              ...
              <div className="my-3">
                  <label htmlFor="email" className="uppercase font-bold text-gray-600">Correo</label>
                  <input 
                    id="email"
                    type="email" 
                    className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"
